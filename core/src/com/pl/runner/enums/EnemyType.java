package com.pl.runner.enums;

import com.pl.runner.utils.Constants;

public enum EnemyType {
    RUNNING_SMALL(1f, 0.9f, Constants.ENEMY_X, Constants.RUNNING_SHORT_ENEMY_Y, Constants.ENEMY_DENSITY),
    RUNNING_WIDE(3.5f, 0.9f, Constants.ENEMY_X, Constants.RUNNING_SHORT_ENEMY_Y, Constants.ENEMY_DENSITY),
